...
app.use(cors({
    origin: ['http://localhost:3007', 
        'http://13.201.63.96:5500',
         'http://localhost:5500',
         'http://13.201.63.96:5502',
         'http://13.201.63.96:5503',
          'http://localhost:3007'],
...
testDatabaseConnection().then(() => {
    app.listen(port, '0.0.0.0', () => {
        ...
        console.log(`Employee Dashboard: http://13.201.63.96:8016${port}/`);
        console.log(`HR Dashboard: http://13.201.63.96:8017${port}/hr`);
    });
}).catch(err => {
