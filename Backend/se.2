...
// Middleware
app.use(cors({
    origin: ['http://13.201.63.96:3091', 
        'http://127.0.0.1:5500',
         'http://13.201.63.96:8016',
         'http://127.0.0.1:5502',
         'http://127.0.0.1:5503',
          'http://13.201.63.96:8017'],
...
testDatabaseConnection().then(() => {
    app.listen(port, '0.0.0.0', () => {
        console.log(`Server running on http://13.201.63.96:${port}`);
        console.log(`Employee Dashboard: http://13.201.63.96:${port}/`);
        console.log(`HR Dashboard: http://13.201.63.96:${port}/hr`);
    });
}).catch(err => {
